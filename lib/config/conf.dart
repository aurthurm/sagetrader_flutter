...
// final String baseURI =  "http://10.42.0.1:8000/"; // dev
final String baseURI =  "https://mspt-api.herokuapp.com/"; // live
...
final String apiEnvironmentVariable = "cloudinary://979235147696769:4QrvbQ_BDUw32ns6WeIf6pABf6U@d3sage";
...
final String apiBaseURL = "https://api.cloudinary.com/v1_1/d3sage"; // added /upload
final String testingPreset = "mspt_testing";
final String msptPreset = "mspt_osok";
final String cloudinaryAPI = "https://$apiKey:$apiSecret@api.cloudinary.com/v1_1/d3sage"; 
