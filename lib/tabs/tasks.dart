  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      Center(
        ...
        onRefresh: () => Provider.of<Tasks>(context, listen: false).fetchTasks(),
      ...
      StaggeredGridView.countBuilder(
        ...
        itemBuilder: (context, index) => GestureDetector(
          child: TaskItem(tasks: tasks, index: index, deleteIndex: longPressedId),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        border: Border.all(
          color: deleteIndex == index ? Colors.red : Theme.of(context).primaryColor.withOpacity(0.7),
          width: 1,
        ),
          ...
          children: <Widget>[
            Text(
              ...
              style:  Theme.of(context).textTheme.headline3.copyWith(
                ...
                color:  deleteIndex == index ? Colors.red : Colors.grey.shade800,
              ),
            ),
            ...
            Text(
              ...
              style:  Theme.of(context).textTheme.bodyText2.copyWith(
                color:  deleteIndex == index ? Colors.red : Colors.grey.shade600,
              ),
            ),
          ],
        ),
